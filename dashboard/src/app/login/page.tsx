      ...
      <main className="relative overflow-hidden">
        ...
        <div className="mx-auto max-w-md px-6 py-24 sm:py-32">
          <div className="text-center">
            <h1 className="font-display text-[clamp(2.2rem,5vw,3.55rem)] leading-[1.05] tracking-[-0.028em]">
              Connect your agent.
            </h1>
            <p className="mx-auto mt-4 max-w-[38ch] text-sub leading-relaxed text-muted">
            ...
            {configured ? (
              ...
              <div className="rounded-xl border border-dashed border-gutter px-5 py-6 text-center">
                ...
                <p className="mt-2 text-read leading-relaxed text-muted">
                  Add <code className="font-mono text-body">NEXT_PUBLIC_SUPABASE_URL</code>{' '}
                  and{' '}
                  <code className="font-mono text-body">NEXT_PUBLIC_SUPABASE_ANON_KEY</code>{' '}
                  to <code className="font-mono text-body">.env.local</code>,
          ...
          <p className="mt-7 text-center text-read text-muted">
            Just here to judge?{' '}
